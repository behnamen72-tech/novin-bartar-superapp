...
replacements = {
    ...
    "backend/app/modules/hr/service.py": [
        ...
        (
            ...
            '            before: dict[str, object] = {"end_date": employment.end_date.isoformat() if employment.end_date else None}',
        ),
    ],
